...
internal static class LootPatch
{
	...
	private static readonly AccessTools.FieldRef<InventoryRandom, Inventory> InventoryField = AccessTools.FieldRefAccess<InventoryRandom, Inventory>("inventory");
	...
	private static void Prefix(InventoryRandom __instance, out State __state)
	{
		...
		Inventory inventory = InventoryField.Invoke(__instance);
	...
	{
		if (__state == null || __state.Inventory == null || __state.Inventory.slots == null)
		{
			return;
		}
	...
	{
		if (item == null || item.baseClass == null || players <= 1)
		{
			return;
		}
