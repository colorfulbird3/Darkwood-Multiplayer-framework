...
public sealed class Plugin : BaseUnityPlugin
{
    ...
    public const string PluginVersion = "0.8.8.1";
    public const string DisplayVersion = "0.8.8-alpha.1";
    ...
    private void Awake()
    {
        ...
        Logger.LogInfo("Darkwood adapter 0.8.8-alpha.1 loaded; single-version handshake gate; trust model (FIX-011/012); runtime entity protocol (Spawn/Despawn messages, host-allocated monotonic ids); stable loot-scale ledger (FIX-008); FIX-003..007 load/snapshot fixes + registry stabilization before Ready.");
    }
