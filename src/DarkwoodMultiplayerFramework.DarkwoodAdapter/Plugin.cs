...
public sealed class Plugin : BaseUnityPlugin
{
    ...
    public const string PluginVersion = "0.8.7.18";
    public const string DisplayVersion = "0.8.7-alpha.18";
    ...
    private void Awake()
    {
        ...
        Logger.LogInfo("Darkwood adapter 0.8.7-alpha.18 loaded; single-version handshake gate; authoritative container/melee/interaction sync; hot-join guest profiles; downed/rescue system; forced load branch + graph-stripped client bundle + joinPaths/graph-deserialize skip (FIX-003/004/005) + registry stabilization before Ready.");
    }
