...
public sealed class Plugin : BaseUnityPlugin
{
    ...
    public const string PluginVersion = "0.8.7.19";
    public const string DisplayVersion = "0.8.7-alpha.19";
    ...
    private void Awake()
    {
        ...
        Logger.LogInfo("Darkwood adapter 0.8.7-alpha.19 loaded; single-version handshake gate; authoritative container/melee/interaction sync; hot-join guest profiles; downed/rescue system; forced load branch + graph-stripped client bundle + joinPaths/graph-deserialize skip + Load-instance-scoped finished callback (FIX-003/004/005/006) + registry stabilization before Ready.");
    }
