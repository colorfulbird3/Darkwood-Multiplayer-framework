...
internal sealed class NetworkStatsRuntime : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		panelTexture = new Texture2D(1, 1, (TextureFormat)4, false);
	...
	{
		if ((Object)(object)panelTexture != (Object)null)
		{
	...
	private void OnGUI()
	{
		...
		if (Plugin.ShowNetworkStats != null && Plugin.ShowNetworkStats.Value)
		{
			...
			if (!((Object)(object)panelTexture == (Object)null))
			{
				...
				((Rect)(ref val))._002Ector((float)Screen.width - 184f - 16f, 14f, 184f, 56f);
				...
				GUI.Label(new Rect(((Rect)(ref val)).x + 10f, ((Rect)(ref val)).y + 4f, ((Rect)(ref val)).width - 20f, 16f), "NETWORK", titleStyle);
				GUI.color = MetricColor(RttMs, LossPercent);
				GUI.Label(new Rect(((Rect)(ref val)).x + 10f, ((Rect)(ref val)).y + 20f, ((Rect)(ref val)).width - 20f, 16f), "FPS " + FormatFps() + "    RTT " + FormatMetric(RttMs, "ms"), labelStyle);
				GUI.color = new Color(0.78f, 0.82f, 0.86f, 0.76f);
				GUI.Label(new Rect(((Rect)(ref val)).x + 10f, ((Rect)(ref val)).y + 36f, ((Rect)(ref val)).width - 20f, 16f), "LOSS " + FormatMetric(LossPercent, "%") + "    JITTER " + FormatMetric(JitterMs, "ms"), labelStyle);
				GUI.color = color;
			}
		}
	}
